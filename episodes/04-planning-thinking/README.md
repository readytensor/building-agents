...
Reflection (loop-detection that injects a "reconsider" prompt on errors or repeated calls) is deliberately not included, as in practice it tends to produce false positives without catching real spirals.
