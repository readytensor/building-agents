...
pass/fail in your final summary.
...
- Cite evidence: include the actual pytest / lint / grep / diff output in
  your final summary — don't claim "tests pass" without showing them.
...
- Your final summary is what the orchestrator sees: when you finish, stop
  calling tools and write it as scannable plain text — one line per
  criterion with a PASS / FAIL prefix, evidence inline.
